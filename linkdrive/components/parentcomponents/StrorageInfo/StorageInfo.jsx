...
const StorageInfo = ({ component }) => {
	...
	const [sizes, setSizes] = useState({ documents: 0, images: 0, audio: 0, others: 0, })

	const [numberOfFiles, setNumberOfFiles] = useState({ documents: 0, images: 0, audio: 0, others: 0, })
	...
	return (
		<div className='bg-white'>
			<UserInfo />
			{component && component}
			{path === '/app/dashboard/storage'|| <StorageDetails
			...
			<div className='w-full h-full p-4'>
				<div className='h-[150px] w-full rounded-xl border bg-black '>
					<div className='w-full h-full rounded-xl p-4 flex flex-col justify-between '>
						...
						<Button className='bg-black hover:bg-green-600 rounded-md text-white'>
							Upgrade
						</Button>
					</div>
				</div>
